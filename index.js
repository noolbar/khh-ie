...
(function($PS) {
  ...
  var textParser = Data_Functor.map(Text_Parsing_StringParser.functorParser)(function ($60) {
      return HtmlText.create($foreign.decodeHtmlEntity($60));
  ...
  var isSelfClosingElement = function (ele) {
      return Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqString)(ele.name)(selfClosingTags);
  };  
  ...
  var charListToString = (function () {
      var $61 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      return function ($62) {
          return Data_String_CodeUnits.fromCharArray($61($62));
      };
  })();
  ...
  var elementParser = Control_Lazy.defer(Text_Parsing_StringParser.lazyParser)(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_CodeUnits.skipSpaces)(function () {
          return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Control_Bind.bind(Text_Parsing_StringParser.bindParser)(openingParser)(closingOrChildrenParser))((function () {
              var $63 = Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser);
              return function ($64) {
                  return $63(HtmlElement.create($64));
              };
          })());
      });
  });
  var closingOrChildrenParser = function (element) {
      ...
      return Control_Lazy.defer(Text_Parsing_StringParser.lazyParser)(function (v) {
          var $59 = isSelfClosingElement(element);
          if ($59) {
...
(function($PS) {
  ...
  var parse = function (raw) {
      return Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Show.show(Text_Parsing_StringParser.showParseError))(Data_Functor.map(Data_Either.functorEither)((function () {
...
(function($PS) {
  ...
  exports["SourceOutput"] = SourceOutput;
...
(function($PS) {
  ...
  var marked = function (a) {
      return $foreign["_marked"](a);
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Pages.Home"] = $PS["Pages.Home"] || {};
  var exports = $PS["Pages.Home"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var render = function (st) {
      return Halogen_HTML_Elements.div_([ Html_Renderer_Halogen.render_(Data_Newtype.unwrap(Text_Marked_Types.newtyepMarkdown)(Text_Marked_Impl.marked("test"))), Halogen_HTML_Core.text(Data_Newtype.unwrap(newtypeURL)(st.url) + (" hash:" + Data_Newtype.unwrap(KKH_Types.newtypeMD5)(st.hash))) ]);
  };
  ...
  var $$default = {
      ...
      note: {
          key: "123",
          cells: [ new KKH_Types.PlainTextCell({
              metadata: "",
              key: "456",
              showable: KKH_Types.SourceOutput.value,
              source: "default Source",
              outputs: [ new KKH_Types.PlainTextOut("default Output") ]
          }) ]
      }
  };
...
(function($PS) {
  ...
  var Pages_Home = $PS["Pages.Home"];
  var Web_Event_EventTarget = $PS["Web.Event.EventTarget"];
  var Web_HTML = $PS["Web.HTML"];
  var Web_HTML_Event_HashChangeEvent = $PS["Web.HTML.Event.HashChangeEvent"];
  var Web_HTML_Event_HashChangeEvent_EventTypes = $PS["Web.HTML.Event.HashChangeEvent.EventTypes"];
  var Web_HTML_Location = $PS["Web.HTML.Location"];
  var Web_HTML_Window = $PS["Web.HTML.Window"];                
  var hashChangeProducer = Control_Coroutine_Aff.produce(function (emitter) {
      return function __do() {
          var listener = Web_Event_EventTarget.eventListener((function () {
              ...
              return function ($4) {
                  return $3(Web_HTML_Event_HashChangeEvent.fromEvent($4));
              };
          })())();
          return Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)((function () {
              var $5 = Web_Event_EventTarget.addEventListener(Web_HTML_Event_HashChangeEvent_EventTypes.hashchange)(listener)(false);
              return function ($6) {
  ...
  var hashChangeConsumer = function (query) {
      return Control_Coroutine.consumer(Effect_Aff.monadAff)(function (event) {
          var hash = Data_String_CodeUnits.drop(1)(Data_String_CodeUnits.dropWhile(function (v) {
              return v !== "#";
          })(Web_HTML_Event_HashChangeEvent.newURL(event)));
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(query(Halogen_Query.tell(Pages_Home.ChangeRoute.create(hash)))))(function () {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Maybe.Nothing.value);
          });
      });
  };
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.location))(Web_HTML_Location.origin)))(function (url) {
          var hash = Data_String_CodeUnits.drop(1)(Data_String_CodeUnits.dropWhile(function (v) {
              return v !== "#";
          })(url));
          var input = {
              url: url,
              hash: hash,
              entryPoint: Pages_Home["default"].entryPoint,
              note: Pages_Home["default"].note
          };
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Pages_Home.component)(input)(body))(function (io) {
              return Control_Coroutine.runProcess(Effect_Aff.monadRecAff)(Control_Coroutine.connect(Effect_Aff.monadRecAff)(Effect_Aff.parallelAff)(hashChangeProducer)(hashChangeConsumer(io.query)));
          });
      });
  }));
