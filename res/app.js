  ...
  var main = (function () {
          ...
          return function (document) {
              return function (node) {
                  ...
                  var getOutput = function (v1) {
                      ...
                      throw new Error("Failed pattern match at Main (line 125, column 9 - line 125, column 39): " + [ v1.constructor.name ]);
                  };
                  var dt = function (v1) {
                      return getOutput(v1);
                  };
                  var appendCell = function ($copy_v1) {
                      return function ($copy_cellbody) {
                          var $tco_var_v1 = $copy_v1;
                          var $tco_done = false;
                          var $tco_result;
                          function $tco_loop(v1, cellbody) {
                              ...
                              if (v1 instanceof KKH_Types.ImagePngCell) {
                                  $tco_var_v1 = new KKH_Types.PlainTextCell(v1.value0);
                                  $copy_cellbody = cellbody;
                                  return;
                              };
                              ...
                              throw new Error("Failed pattern match at Main (line 102, column 9 - line 102, column 53): " + [ v1.constructor.name, cellbody.constructor.name ]);
                          };
                          while (!$tco_done) {
                              $tco_result = $tco_loop($tco_var_v1, $copy_cellbody);
                          };
                          return $tco_result;
                      };
                  };
      ...
      return function __do() {
          ...
          Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)((function () {
              var $36 = Web_Event_EventTarget.addEventListener(Web_HTML_Event_HashChangeEvent_EventTypes.hashchange)(listener)(false);
              return function ($37) {
                  return $36(Web_HTML_Window.toEventTarget($37));
              };
          })())();
                  ...
                  if (maybeBody instanceof Data_Maybe.Just) {
                      return function __do() {
                          ...
                          if (result instanceof Data_Either.Right) {
                              ...
                              throw new Error("Failed pattern match at Main (line 65, column 13 - line 69, column 48): " + [ v.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main (line 61, column 9 - line 69, column 48): " + [ result.constructor.name ]);
                      };
                  };
                  throw new Error("Failed pattern match at Main (line 54, column 16 - line 69, column 48): " + [ maybeBody.constructor.name ]);
              })());
          }))();
      };
  })();
