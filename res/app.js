...
(function($PS) {
  ...
  var readForeignURL = new Simple_JSON.ReadForeign(function (o) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Simple_JSON.readImpl(Simple_JSON.readString)(o))(function (str) {
          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))(str);
      });
  });
  ...
  var readForeignNote = new Simple_JSON.ReadForeign(function (o) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Control_Bind.bindFlipped(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Simple_JSON.readImpl(readForeignMD5))(Foreign_Index.readProp("key")(o)))(function (v) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Control_Bind.bindFlipped(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Simple_JSON.readImpl(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "title";
          }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "url";
          }))(readForeignURL)(Simple_JSON.readFieldsNil)()())()()))))(Foreign_Index.readProp("directories")(o)))(function (v1) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Control_Bind.bindFlipped(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Simple_JSON.readImpl(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "title";
              }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "url";
              }))(readForeignURL)(Simple_JSON.readFieldsNil)()())()()))))(Foreign_Index.readProp("dependencies")(o)))(function (v2) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Control_Bind.bindFlipped(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Simple_JSON.readImpl(Simple_JSON.readArray(readForeignCell)))(Foreign_Index.readProp("cells")(o)))(function (v3) {
...
(function($PS) {
  "use strict";
  $PS["Image.Impl"] = $PS["Image.Impl"] || {};
  var exports = $PS["Image.Impl"];
  var Data_Newtype = $PS["Data.Newtype"];
  var KKH_Types = $PS["KKH.Types"];
  var Web_DOM_Document = $PS["Web.DOM.Document"];
  var Web_DOM_Element = $PS["Web.DOM.Element"];                
  var createImagedNode = function (imageType) {
      return function (a) {
          return function (document) {
              return function __do() {
                  var elem = Web_DOM_Document.createElement("img")(document)();
                  Web_DOM_Element.setAttribute("src")("data:image/" + (imageType + (";base64," + Data_Newtype.unwrap(KKH_Types.newtypeBase64)(a))))(elem)();
                  return Web_DOM_Element.toNode(elem);
              };
          };
      };
  };
  exports["createImagedNode"] = createImagedNode;
})(PS);
(function(exports) {
  'use strict';
...
})(PS["Text.Marked.Impl"] = PS["Text.Marked.Impl"] || {});
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Text.Marked.Types"] = $PS["Text.Marked.Types"] || {};
  var exports = $PS["Text.Marked.Types"];
  var Data_Newtype = $PS["Data.Newtype"];              
  var Markdown = function (x) {
      return x;
  }; 
  var newtyepMarkdown = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Markdown);
  exports["newtyepMarkdown"] = newtyepMarkdown;
})(PS);
(function(exports) {
  "use strict";                                   
...
(function($PS) {
  ...
  "use strict";
  $PS["Text.Marked.Impl"] = $PS["Text.Marked.Impl"] || {};
  var exports = $PS["Text.Marked.Impl"];
  var $foreign = $PS["Text.Marked.Impl"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Function_Uncurried = $PS["Data.Function.Uncurried"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Newtype = $PS["Data.Newtype"];
  var Effect = $PS["Effect"];
  var Text_Marked_Types = $PS["Text.Marked.Types"];
  var Web_DOM_Document = $PS["Web.DOM.Document"];
  var Web_DOM_Element = $PS["Web.DOM.Element"];
  var Web_DOM_Node = $PS["Web.DOM.Node"];                
  var appendMarkedNode = function (a) {
      return function (document) {
          return function (node) {
              return function __do() {
                  var str = $foreign["_marked"](Data_Newtype.unwrap(Text_Marked_Types.newtyepMarkdown)(a))();
                  return Data_Functor["void"](Effect.functorEffect)(function __do() {
                      var elem = Web_DOM_Document.createElement("a")(document)();
                      var e = Web_DOM_Element.toNode(elem);
                      return Control_Bind.bind(Effect.bindEffect)(Web_DOM_Node.appendChild(e)(node))(Data_Function_Uncurried.runFn2($foreign["_outerHTML"])(str))();
                  })();
              };
          };
      };
  };
  exports["appendMarkedNode"] = appendMarkedNode;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var Effect_Console = $PS["Effect.Console"];
  var Foreign = $PS["Foreign"];
  var Image_Impl = $PS["Image.Impl"];
  var KKH_Types = $PS["KKH.Types"];
  var Simple_JSON = $PS["Simple.JSON"];
  var Text_Marked_Impl = $PS["Text.Marked.Impl"];
  var Web_DOM_Document = $PS["Web.DOM.Document"];
  var Web_DOM_Element = $PS["Web.DOM.Element"];
  var Web_DOM_Node = $PS["Web.DOM.Node"];
  ...
  var main = (function () {
          ...
          return function (document) {
              return function (node) {
                  var wall = function (r) {
                      return function (str) {
                          return function __do() {
                              var elem = Web_DOM_Document.createElement("PlainText")(document)();
                              Web_DOM_Element.setAttribute("id")(Data_Newtype.unwrap(KKH_Types.newtypeMD5)(r.key))(elem)();
                              Web_DOM_Element.setAttribute("style")(showattr(str)(r.showable))(elem)();
                              return Web_DOM_Element.toNode(elem);
                          };
                      };
                  };
                  var imageData = function (v1) {
                      if (v1 instanceof Data_Maybe.Just) {
                          var getOutput = function (v2) {
                              if (v2 instanceof KKH_Types.ImagePngOut) {
                                  return v2.value0;
                              };
                          ...
                          return getOutput(v1.value0);
                      };
                      return "";
                  };
                  var dt = function (v1) {
                      var getOutput = function (v2) {
                          if (v2 instanceof KKH_Types.PlainTextOut) {
                              return v2.value0;
                          };
                          if (v2 instanceof KKH_Types.MarkDownOut) {
                              return v2.value0;
                          };
                          if (v2 instanceof KKH_Types.ImagePngOut) {
                  ...
                  var appendCell = function (v1) {
                      return function (cellbody) {
                          if (v1 instanceof KKH_Types.PlainTextCell) {
                              return function __do() {
                                  var sNode = wall(v1.value0)("source")();
                                  Web_DOM_Node.setTextContent(v1.value0.source)(sNode)();
                                  return Data_Functor["void"](Effect.functorEffect)(Web_DOM_Node.appendChild(sNode)(cellbody))();
                              };
                          };
                          if (v1 instanceof KKH_Types.CodeCell) {
                              return function __do() {
                                  var sNode = wall(v1.value0)("source")();
                                  Web_DOM_Node.setTextContent("source: " + v1.value0.source)(sNode)();
                                  var oNode = wall(v1.value0)("output")();
                                  Web_DOM_Node.setTextContent("output: " + Data_Foldable.foldr(Data_Foldable.foldableArray)(Data_Semigroup.append(Data_Semigroup.semigroupString))("")(Data_Functor.map(Data_Functor.functorArray)(dt)(v1.value0.outputs)))(oNode)();
                                  Data_Functor["void"](Effect.functorEffect)(Web_DOM_Node.appendChild(sNode)(cellbody))();
                                  return Data_Functor["void"](Effect.functorEffect)(Web_DOM_Node.appendChild(oNode)(cellbody))();
                              };
                          };
                          ...
                          if (v1 instanceof KKH_Types.ImagePngCell) {
                              return function __do() {
                                  var dNode = Image_Impl.createImagedNode("png")(imageData(Data_Array.head(v1.value0.outputs)))(document)();
                                  return Data_Functor["void"](Effect.functorEffect)(Web_DOM_Node.appendChild(dNode)(cellbody))();
                              };
                          };
                          if (v1 instanceof KKH_Types.ImageJpegCell) {
                              return function __do() {
                                  var dNode = Image_Impl.createImagedNode("jpeg")(imageData(Data_Array.head(v1.value0.outputs)))(document)();
                                  return Data_Functor["void"](Effect.functorEffect)(Web_DOM_Node.appendChild(dNode)(cellbody))();
                              };
                          };
                          throw new Error("Failed pattern match at Main (line 104, column 9 - line 104, column 53): " + [ v1.constructor.name, cellbody.constructor.name ]);
                      };
                  };
                  return function __do() {
                      var celldiv = (function __do() {
                          var elem = Web_DOM_Document.createElement("div")(document)();
                          Web_DOM_Element.setAttribute("style")("border: solid; word-break: break-all;")(elem)();
                          return Web_DOM_Element.toNode(elem);
                      })();
                      return Control_Bind.bind(Effect.bindEffect)(Web_DOM_Node.appendChild(celldiv)(node))(appendCell(v))();
                  };
              };
          };
      };
      var addLinks = function (link) {
          return function (document) {
              return function (node) {
                  return function __do() {
                      var ref = (function __do() {
                          var elem = Web_DOM_Document.createElement("a")(document)();
                          Web_DOM_Element.setAttribute("href")(Data_Newtype.unwrap(KKH_Types.newtypeURL)(link.url))(elem)();
                          Web_DOM_Node.setTextContent(link.title)(Web_DOM_Element.toNode(elem))();
                          return Web_DOM_Element.toNode(elem);
                      })();
                      var div = Data_Functor.map(Effect.functorEffect)(Web_DOM_Element.toNode)(Web_DOM_Document.createElement("div")(document))();
                      return Data_Functor["void"](Effect.functorEffect)(Control_Bind.bind(Effect.bindEffect)(Web_DOM_Node.appendChild(div)(node))(Web_DOM_Node.appendChild(ref)))();
                  };
              };
          };
      };
      var mkContainer = function (v) {
          return function (document) {
              return function (body) {
                  var node = Web_HTML_HTMLElement.toNode(body);
                  return function __do() {
                      var contmemu = (function __do() {
                          var elem = Web_DOM_Document.createElement("div")(document)();
                          Web_DOM_Element.setAttribute("style")("width: 200px; float: left;")(elem)();
                          return Web_DOM_Element.toNode(elem);
                      })();
                      Data_Functor["void"](Effect.functorEffect)(function __do() {
                          var memu = Web_DOM_Node.appendChild(contmemu)(node)();
                          Data_Functor["void"](Effect.functorEffect)(function __do() {
                              var div = Data_Functor.map(Effect.functorEffect)(Web_DOM_Element.toNode)(Web_DOM_Document.createElement("div")(document))();
                              var elem = Web_DOM_Node.appendChild(div)(memu)();
                              Web_DOM_Node.setTextContent("Directories")(elem)();
                              return Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(function (l) {
                                  return addLinks(l)(document)(elem);
                              })(v.directories)();
                          })();
                          return Data_Functor["void"](Effect.functorEffect)(function __do() {
                              var div = Data_Functor.map(Effect.functorEffect)(Web_DOM_Element.toNode)(Web_DOM_Document.createElement("div")(document))();
                              var elem = Web_DOM_Node.appendChild(div)(memu)();
                              Web_DOM_Node.setTextContent("Dependencies")(elem)();
                              return Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(function (l) {
                                  return addLinks(l)(document)(elem);
                              })(v.dependencies)();
                          })();
                      ...
                      return Data_Functor["void"](Effect.functorEffect)(function __do() {
                          var elem = Web_DOM_Document.createElement("div")(document)();
                          Web_DOM_Element.setAttribute("style")("width: 80vw; float: left;")(elem)();
                          var div = Web_DOM_Element.toNode(elem);
                          var cellcont = Web_DOM_Node.appendChild(div)(node)();
                          return Data_Functor["void"](Effect.functorEffect)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(function (c) {
                              return render(c)(document)(cellcont);
                          })(v.cells))();
                      })();
                  };
              };
      ...
      return function __do() {
          ...
          var listener = Web_Event_EventTarget.eventListener(Data_Function["const"](Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.location))(Web_HTML_Location.reload)))();
          Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)((function () {
              var $43 = Web_Event_EventTarget.addEventListener(Web_HTML_Event_HashChangeEvent_EventTypes.hashchange)(listener)(false);
              return function ($44) {
                  return $43(Web_HTML_Window.toEventTarget($44));
              };
          })())();
          return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
              ...
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                  ...
                  if (maybeBody instanceof Data_Maybe.Just) {
                      return function __do() {
                          var pNode = Data_Functor.map(Effect.functorEffect)(Web_DOM_Element.toNode)(Web_DOM_Document.createElement("h2")(document))();
                          Control_Bind.bind(Effect.bindEffect)(Web_DOM_Node.appendChild(pNode)(Web_HTML_HTMLElement.toNode(maybeBody.value0)))(Web_DOM_Node.setTextContent("KHHnote for IE" + (": " + hash)))();
                          if (result instanceof Data_Either.Left) {
                              return Effect_Class_Console.log(Effect_Class.monadEffectEffect)("GET note response failed to decode: " + Affjax.printError(result.value0))();
                          };
                          if (result instanceof Data_Either.Right) {
                              Effect_Class_Console.log(Effect_Class.monadEffectEffect)("GET note response: " + result.value0.body)();
                              var v = Simple_JSON.readJSON(KKH_Types.readForeignNote)(result.value0.body);
                              if (v instanceof Data_Either.Right) {
                                  Effect_Class_Console.log(Effect_Class.monadEffectEffect)("GET note response: " + Data_Newtype.unwrap(KKH_Types.newtypeMD5)(v.value0.key))();
                                  return mkContainer(v.value0)(document)(maybeBody.value0)();
                              };
                              if (v instanceof Data_Either.Left) {
                              ...
                              throw new Error("Failed pattern match at Main (line 67, column 13 - line 71, column 48): " + [ v.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main (line 63, column 9 - line 71, column 48): " + [ result.constructor.name ]);
                      };
                  };
                  throw new Error("Failed pattern match at Main (line 56, column 16 - line 71, column 48): " + [ maybeBody.constructor.name ]);
              })());
          }))();
      };
  })();
